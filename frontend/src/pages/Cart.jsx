        ...
        <div className="lg:col-span-2 space-y-4">
          <div className="bg-base-200 rounded-2xl shadow-lg border border-neutral/20 overflow-hidden">
            ...
            <div className="divide-y divide-neutral/10">
              {cartItems.map((item) => (
                <div key={`${item.id}-${item.size}`} className="p-4 md:p-6 flex flex-col md:flex-row gap-6 items-center md:items-start transition-colors hover:bg-base-300/10">
                  ...
                  <div className="flex-1 text-center md:text-left">
                    ...
                    <p className="text-sm text-base-content/50 font-bold uppercase tracking-widest mt-1">
                      Crumbskate {item.size ? `| Talle ${item.size}` : ''}
                    </p>
