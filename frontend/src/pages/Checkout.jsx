             ...
             <form id="checkout-form" onSubmit={handleCheckout} className="space-y-4">
               ...
               <div className="grid grid-cols-2 gap-4">
                  <div className="form-control">
                    ...
                    <input required type="text" className="input input-bordered" placeholder="Juan" defaultValue={user?.name?.split(' ')[0]} />
                  </div>
                  <div className="form-control">
                    <label className="label text-[10px] uppercase font-black opacity-50">Apellido</label>
                    <input required type="text" className="input input-bordered" placeholder="Perez" defaultValue={user?.name?.split(' ')[1] || ''} />
                  </div>
               </div>
               <div className="form-control">
